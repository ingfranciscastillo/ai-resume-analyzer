                    ...
                    <section className="py-16 md:py-32 relative z-50">
                        <div className="mx-auto max-w-5xl rounded-3xl border px-6 py-12 lg:py-32">
                            <div className="text-center">
                                <h2 className="text-balance text-4xl font-semibold lg:text-5xl">No se encontró ningún currículum.</h2>
                                <p className="mt-4 truncate">Aún no has creado ninguna reseña. Comienza subiendo tu primer currículum para recibir una evaluación.</p>
